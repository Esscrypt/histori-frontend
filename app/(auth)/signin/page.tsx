...
function SignInContent() {
  ...
  const queryParams = searchParams.toString(); // Get the current query params if they exist
  const signinUrl = queryParams ? `/signup?${queryParams}` : '/signup';
            ...
            <div className="w-full max-w-lg mx-auto">
              ...
              <div className="space-y-3">
                ...
                <blockquote className="text-slate-400 italic">
                  "People don’t buy what you do; they buy <em>why</em> you do it. At Histori, we believe that access to data is the key to shaping the future. By empowering you with fast, scalable, and secure historical blockchain data, we help you turn the unknown into an opportunity."
                </blockquote>
              </div>
              ...
              <div className="mt-8">
                <a href={signinUrl} className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
