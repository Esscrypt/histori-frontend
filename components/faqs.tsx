        ...
        <div className="py-12 md:py-20 border-t border-slate-50">
          ...
          <ul className="max-w-3xl mx-auto divide-y divide-slate-200">
            ...
            <Accordion title="What blockchains do you support?">
              Currently, Histori supports more than 50 networks and we are continuously expanding support to other blockchains based on demand.
            </Accordion>
            ...
            <Accordion title="How does Histori handle rate limits?">
              Rate limits are based on your subscription tier. Each plan offers different request limits per month, and if you exceed your limit, you can upgrade your plan or wait for the next billing cycle.
            </Accordion>
