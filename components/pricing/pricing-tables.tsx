...
export default function PricingTables() {
  ...
  const handleCheckoutSession = async (key: string) => {
    ...
    try {
      const response = await axiosInstance.post('/payments/create-checkout-session', { lookup_key: key });
      ...
      <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none pt-4">
        ...
        >
          <div className="mb-4 pb-4 border-b border-slate-200">
            ...
            <div className="text-slate-500">
              Ideal for Testing and small-scale experimentation with limited data
              needs.
            </div>
          </div>
        ...
        >
          <div className="mb-4 pb-4 border-b border-slate-200">
            ...
            <div className="text-slate-500">
              Better insights for startups or small applications requiring
              moderate API usage.
            </div>
          </div>
          <div className="font-medium mb-3">Features include:</div>
        ...
        >
          ...
          <div className="mb-4 pb-4 border-b border-slate-200">
            ...
            <div className="text-slate-500">
              For growing businesses with higher API demands and steady growth.
            </div>
          </div>
        ...
        >
          <div className="mb-4 pb-4 border-b border-slate-200">
            ...
            <div className="text-slate-500">
              Better insights for Larger businesses or enterprises requiring
