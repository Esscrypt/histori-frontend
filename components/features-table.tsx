              ...
              <table className="table-auto w-full border-b border-slate-200">
                ...
                <thead>
                  <tr className="text-base sm:text-lg text-slate-800">
                    ...
                    <th className="text-bold text-center px-2 py-4">Business</th>
                ...
                <tbody>
                  ...
                  <tr className="border-t first:border-t-2 border-slate-200">
                    ...
                    <td className="text-sm px-2 py-4 text-center italic text-slate-800">50000</td>
                    <td className="text-sm px-2 py-4 text-center italic text-slate-800">300000</td>
                    <td className="text-sm px-2 py-4 text-center italic text-slate-800">700000</td>
                    <td className="text-sm px-2 py-4 text-center italic text-slate-800">Custom</td>
                  </tr>
